...
class EditarMetaScreen extends StatefulWidget {
  ...
  const EditarMetaScreen({required this.meta, super.key});
...
class _EditarMetaScreenState extends State<EditarMetaScreen> {
  ...
  late TextEditingController prazoController;
  ...
  Future<void> _atualizarMeta() async {
    ...
    try {
      ...
      final metaAtualizada = MetaDto(
        ...
        dataCriacao: widget.meta.dataCriacao,
      );

      await metasRepository.atualizarMeta(metaAtualizada);
